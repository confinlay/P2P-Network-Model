...
files = {"Marigold" : "Each flower a wilting sun\nThe death of a new day is never kind\nGrief ain’t no song\nNo loss is this romantic" , "In a station of a metro" : "The apparition of these faces in the crowd:\nPetals on a wet, black bough."}
file_locations = {"Secrets under trees" : "3", "The dark days will pass" : "5", "Little baby" : "5", "Drowning" : "3", "A fallen leaf" : "2", "Nothing gold can stay" : "1", "Underface" : "1"} 
    ...
    while connected :
        ...
        if msg_length:
            ...
            if file_found:
                ...
                conn.send(f"\nFILE UNKNOWN. TRY MY NEAREST NEIGHBOUR PEER 1.\n".encode(FORMAT))
