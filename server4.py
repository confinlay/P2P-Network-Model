...
files = {"Like the moon": "I will be\nlike the moon\nand learn to shine\neven when\nI am not whole." , "Someday" : "Someday you will cry for me\nLike I cried for you.\nSomeday you'll miss me\nLike I missed you.\nSomeday you'll need me \nLike I needed you.\nSomeday you'll love me,\nBut I won't love you."}
file_locations = {"A fallen leaf" : "2" ,"Drowning" : "3", "Marigold" : "6", "Little baby" : "5", "The dark days will pass" : "5", "Secrets under trees" : "3", "A fallen leaf" : "2", "Nothing gold can stay" : "1"} 
    ...
    while connected :
        ...
        if msg_length:
            ...
            if file_found:
                ...
                conn.send(f"\nFILE UNKNOWN. TRY MY NEAREST NEIGHBOUR PEER 5.\n".encode(FORMAT))
